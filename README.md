...
7.  Then, the Choice state (“Is alarm still in ALARM state?” in the following figure) checks the alarm state returned by the Lambda function and directs the workflow as follows:
